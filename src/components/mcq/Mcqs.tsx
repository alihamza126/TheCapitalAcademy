	...
	const saveMcqData = async () => {
		if (correctMcq.length > 0 || wrongMcq.length > 0) {
			try {
				...
				let response = await Axios.put('/mcq/solved', { correctMcq, wrongMcq, userId });
			...
			<div className="mcqs">
				<div className="container">
					<div className="mcq-topbar">
						<div className='top'>
							<div className="left bg-gray-300 px-2 py-1 text-primary d-flex align-item-center back-btn" onClick={() => router.back()}>
								<ArrowBack />Back
							</div>
						...
						<div className="box">
							<div className="instructions shadow-lg">
								...
								<div className="button-box  w-auto p-2 mt-4">
									<button className='quit' onClick={() => router.back()}>Quit</button>
						...
						<div class="grid-container">
							...
							<div class="banner-right">
								...
								<div class="button">
									...
									<button className='mt-2 ' onClick={() => router.back()}>Continue</button>
								</div>
							</div>
						</div>
					</Modal.Body>
