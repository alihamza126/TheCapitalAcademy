				...
				<div className="flex-1 px-2 md:px-4 lg:px-6 pb-6 overflow-hidden">
					<div className="h-full grid grid-cols-1 lg:grid-cols-4 gap-6">
						...
						<div className="lg:col-span-3 h-full flex flex-col">
							<Card
								className="shadow-xl flex-1 flex flex-col overflow-hidden"
											...
											<div className="flex-shrink-0">
												...
												<Card className="bg-slate-50 border-l-4 border-l-blue-500">
													<CardBody className="py-3 lg:py-4">
														<MathJax dynamic={true} className="text-base lg:text-lg leading-relaxed">
															{mcqs[index]?.question}
														</MathJax>
													</CardBody>
												</Card>
															...
															<div className="space-y-3">
																{mcqs[index]?.options.map((option, optionIndex) => (
																	<div
																		...
																		className="mcq-option p-3 lg:p-4 border-2 border-gray-200 rounded-xl cursor-pointer transition-all duration-300 hover:border-blue-400 hover:shadow-md active:scale-[0.98]"
																	>
																		<div className="flex items-center gap-3">
																			<Chip
																				variant="flat"
