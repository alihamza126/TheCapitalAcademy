...
export default function TestSeriesPage() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-slate-800 mb-2">Test Series</h1>
        <p className="text-slate-600">Explore and enroll in comprehensive test series for your preparation</p>
      </div>
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
        <Card className="shadow-md border-0">
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <Button icon={<FilterOutlined />} size="large" className="hover:text-blue-600 hover:border-blue-600">
              More Filters
            </Button>
          </div>
        </Card>
